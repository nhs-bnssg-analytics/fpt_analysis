...
* accuracy measure? Is Rsq appropriate? Need to pick a measure that suits the question we have...we're most interested in trends for each ICS (MDA? or SMAPE?)
...
* Theatre capacity?
* are there any publications from the mental health minimum dataset or the community services minimum dataset
* can any of the performance metrics be used as predictors
